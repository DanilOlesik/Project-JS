const API_KEY = "b0ee8933-d927-492a-9297-ad7edb8859ec";
  ...
  modalEl.innerHTML = `
    <div class="modal__card">
      ...
      <ul class="modal__movie-info">
        ...
        ${
          respData.filmLenght
            ? `<li class="modal__movie-runtime">Время - ${respData.filmLenght} минут</li>`
            : ""
        }
        <li>Сайт<a class="modal__movie-site" href="${respData.webUrl}"> ${
    respData.webUrl
  }</a></li>
        <li class="modal__movie-overwiew">Описание: ${respData.description}</li>
      </ul>
